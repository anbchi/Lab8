    ...
    */
    describe('properly changed icon', () => {
        test('is icon level 3', () => {
            expect(format(78)).toBe(`./assets/media/icons/volume-level-3.svg`);
            /*
            if (volumeValue > 66) {
        ...
        test('is icon level 2', () => {
            expect(format(50)).toBe(`./assets/media/icons/volume-level-2.svg`);
            /*
        ...
        test('is icon level 1', () => {
            expect(format(20)).toBe(`./assets/media/icons/volume-level-1.svg`);
            /*
